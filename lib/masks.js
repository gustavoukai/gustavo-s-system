...
// Usada em Contas a Pagar: só dígitos, sempre fecha em ",00" (sem centavos digitáveis).
...
// Usada em Cobranças: aceita dígitos e, opcionalmente, uma vírgula com os centavos.
// O campo guarda o texto cru digitado (só dígitos e vírgula); estas três funções
// só calculam a prévia formatada e o número final, sem reescrever o campo (evita
// o bug de reformatar em cima do próprio valor já formatado).
